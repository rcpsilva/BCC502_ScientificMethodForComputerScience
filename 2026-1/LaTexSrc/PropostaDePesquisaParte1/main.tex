...
As respostas desta atividade deverão ser submetidas no Moodle em formato PDF, elaboradas obrigatoriamente a partir do \textit{template} disponibilizado no repositório da disciplina no GitHub \url{}.
