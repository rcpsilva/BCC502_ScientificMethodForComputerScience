...
Estudos dirigidos: Atividades individuais que podem ser entrevistas ou testes feitos durante as aulas.
...
Apresentações dos trabalhos desenvolvidos pelos alunos.
...
Estudos dirigidos (E) no valor de 10 pontos.

Proposta de projeto de pesquisa (P), no valor de 10 pontos.

Apresentação da proposta (A), no valor de 10 pontos

Nota final = 0.3 * E + 0.35 * P + 0.35 * A